    ...
    with st.expander(
        ...
        if not step1_done or not step2_done:
            ...
            st.markdown(
                ...
                "2. In the app detail page, click the **Configurations** tab "
                "(look for the gear icon or the ⋮ menu → Manage Access)\n"
            ...
            st.info(
                "💡 **Tip:** The Configurations tab can be hard to find. "
                "In Snowsight, go to **Data Products → Apps**, click your app name, "
                "then look for **Configurations** in the top tab bar or under the ⋮ menu."
            )
        if not step3_done and (step1_done and step2_done):
            ...
            st.markdown(
                ...
                "3. You will see a row of tabs: **About the app / Permissions / App events / Configurations / ...**\n"
            ...
            st.info(
                "**Can't find the Configurations tab?**\n\n"
                "The Configurations tab is on the **Snowsight Native App management page**, "
                ...
                "to the management page where the Configurations tab is visible."
            )
